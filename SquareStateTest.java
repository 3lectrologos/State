...
public class SquareStateTest extends TestCase {
	...
	public void testNext() {
		State state1 = new SquaresState(new int[][] {{1, 2, 3}, {4, 5, 6}, {7, 8, 0}});
		State state2 = new SquaresState(new int[][] {{1, 2, 3}, {4, 5, 0}, {7, 8, 6}});
		State state3 = new SquaresState(new int[][] {{1, 2, 3}, {4, 5, 6}, {7, 0, 8}});
	...
	public void testNext2() {
		State state1 = new SquaresState(new int[][] {{3, 1, 4}, {7, 0, 8}, {2, 6, 5}});
		State state2 = new SquaresState(new int[][] {{3, 1, 4}, {0, 7, 8}, {2, 6, 5}});
		State state3 = new SquaresState(new int[][] {{3, 0, 4}, {7, 1, 8}, {2, 6, 5}});
		State state4 = new SquaresState(new int[][] {{3, 1, 4}, {7, 8, 0}, {2, 6, 5}});
		State state5 = new SquaresState(new int[][] {{3, 1, 4}, {7, 6, 8}, {2, 0, 5}});
